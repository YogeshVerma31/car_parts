...
const Color darkBlueColor = Color(0xFF3B5999);
const Color orangeColor = Color(0xFFEF8B1B);
const Color blackColor400 = Color(0xFF272D3B);
const Color lightPinkColor = Color(0xFFE6E0E0);
